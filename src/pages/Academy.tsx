  ...
  const offers: Offer[] = [
    {
      ...
      description: 'Personalized coaching sessions tailored to your specific goals and challenges. Work directly with our expert coaches to accelerate your growth and overcome obstacles.',
      features: [
    ...
    },
    {
      ...
      description: 'Self-paced learning journeys that provide comprehensive knowledge and practical skills. Access expert-created content anytime, anywhere.',
      features: [
    ...
    <div>
                ...
                <div className="grid md:grid-cols-2">
                  ...
                  <div className="p-8">
                    ...
                    <div className="flex items-end gap-2 mb-6">
                      <span className="text-3xl font-serif font-medium">{offer.price}</span>
                      <span className="text-primary/70">{offer.priceDescription}</span>
                    </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-sm">
              ...
              <p className="text-primary/80 italic">
                "The one-on-one coaching sessions have been transformative. My coach understood exactly what I needed and helped me create a personalized growth plan that has already yielded fantastic results."
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm">
              ...
              <p className="text-primary/80 italic">
                "The group workshops provided not just expert guidance but also a supportive community. The diverse perspectives and shared experiences made the learning journey incredibly enriching."
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm">
              ...
              <p className="text-primary/80 italic">
                "The online courses are comprehensive and well-structured. Being able to learn at my own pace while still having access to community support made it the perfect learning experience for my busy schedule."
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 bg-primary text-white">
        <div className="container-custom text-center">
          <h2 className="text-3xl md:text-4xl font-serif font-medium mb-6">Ready to Begin Your Growth Journey?</h2>
          <p className="text-white/80 max-w-2xl mx-auto mb-8">
            Explore our offerings and find the perfect learning path for your personal and professional development.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link to="/join" className="bg-white text-primary px-6 py-3 rounded-md font-medium hover:bg-nude-100 transition-colors">
              Join Our Community
            </Link>
            <a href="#" className="border border-white text-white px-6 py-3 rounded-md font-medium hover:bg-white/10 transition-colors">
              Contact Us
            </a>
          </div>
        </div>
