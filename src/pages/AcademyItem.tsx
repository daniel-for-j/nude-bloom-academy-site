...
const offerData = {
  'coaching': {
    ...
    image: 'https://images.unsplash.com/photo-1516387938699-a93567ec168e?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=800&q=80'
  },
  'workshops': {
    type: 'Group Workshops',
    title: 'Collaborative Growth Experiences',
    description: 'Our interactive workshops bring together small groups of individuals with similar goals and challenges, creating a powerful environment for learning, sharing, and growth. Led by expert facilitators, these sessions combine structured learning with peer interaction to maximize your development.',
    benefits: [
  ...
  'courses': {
    ...
    description: 'Our comprehensive online courses allow you to learn at your own pace while still benefiting from expert instruction and community support. Each course combines video lessons, practical exercises, and supplementary resources to provide a complete learning experience.',
    benefits: [
    ...
    courses: [
      {
        ...
        description: 'Learn how to define, develop, and communicate your personal brand effectively to advance your career and stand out in your field.',
        modules: '8 modules',
      ...
      },
      {
        ...
        description: 'Develop your emotional intelligence to become a more effective leader, build stronger relationships, and create positive team cultures.',
        modules: '10 modules',
      ...
      },
      {
        ...
        description: 'Master practical strategies and tools to maximize your productivity, manage your time effectively, and achieve more with less stress.',
        modules: '6 modules',
...
const AcademyItem = () => {
  ...
  const [offerType, setOfferType] = useState<keyof typeof offerData | null>(null);
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-3xl font-serif font-medium mb-4">Offer Not Found</h1>
          <p className="mb-6 text-primary/70">The requested academy offering could not be found.</p>
    ...
    <div>
      ...
      <section className="py-8 bg-nude-100">
        <div className="container-custom">
          <Link to="/academy" className="inline-flex items-center text-primary hover:text-primary/80 transition-colors">
      ...
      <section className="py-16 bg-nude-50">
        <div className="container-custom">
          <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
            <div>
              <h2 className="text-3xl md:text-4xl font-serif font-medium mb-6">{offer.title}</h2>
          ...
          <div className="mb-16">
            <h3 className="text-2xl font-serif font-medium mb-6">Our Process</h3>
          ...
          {offerType === 'coaching' && (
            <div>
              <h3 className="text-2xl font-serif font-medium mb-6">Pricing Options</h3>
              <div className="grid md:grid-cols-3 gap-6">
                {offer.pricing.map((plan, index) => (
                  <div 
                    key={index}
                    className={`bg-white rounded-lg overflow-hidden shadow-sm ${plan.recommended ? 'border-2 border-primary ring-2 ring-primary ring-opacity-10' : 'border border-nude-200'}`}
                  >
                    {plan.recommended && (
                    ...
                    <div className="p-6">
                      ...
                      <div className="text-3xl font-serif font-medium mb-4">{plan.price}</div>
                      ...
                      <button 
                        ...
                        className={`w-full py-2 rounded-md font-medium transition-colors ${
                          plan.recommended 
                            ...
                            : 'bg-nude-200 text-primary hover:bg-nude-300'
                        }`}
                      >
                        Select Plan
                      </button>
          ...
          {offerType === 'workshops' && (
            <div>
              <h3 className="text-2xl font-serif font-medium mb-6">Upcoming Workshops</h3>
              <div className="space-y-4">
                {offer.upcoming.map((workshop, index) => (
                  <div key={index} className="bg-white p-6 rounded-lg shadow-sm border border-nude-200">
                    <div className="flex flex-col md:flex-row md:items-center md:justify-between">
                      <div>
                        ...
                        <div className="mt-2 text-sm text-primary/70">{workshop.spots}</div>
                      </div>
                      <div className="mt-4 md:mt-0 flex items-center">
                        <div className="text-2xl font-serif font-medium mr-4">{workshop.price}</div>
                        <button 
                          onClick={() => handlePurchase(workshop.title, workshop.price)}
          ...
          {offerType === 'courses' && (
            <div>
              <h3 className="text-2xl font-serif font-medium mb-6">Available Courses</h3>
                  ...
                  <div key={index} className="bg-white p-6 rounded-lg shadow-sm border border-nude-200">
                    <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between">
                      <div className="flex-1">
                        ...
                        <p className="text-primary/80 mb-3">{course.description}</p>
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-sm">
                          <div className="bg-nude-100 p-3 rounded-md">
                            <div className="font-medium">Course Length</div>
                      ...
                      <div className="mt-6 lg:mt-0 lg:ml-8 flex flex-col items-center">
                        <div className="text-2xl font-serif font-medium mb-3">{course.price}</div>
                        <button 
      ...
      <section className="py-16 bg-nude-200">
        <div className="container-custom text-center">
          <h2 className="text-3xl md:text-4xl font-serif font-medium mb-6">Have Questions?</h2>
          <p className="text-lg text-primary/80 max-w-2xl mx-auto mb-8">
            Our team is here to help you choose the right learning path for your goals. Contact us for more information or to discuss your specific needs.
          </p>
